...
function Search({searchFood}) {
    ...
    const makeSearch = (e) => {
        ...
        // ( Puede que sea mala práctica cambiar el nombre de las cosas al llevarlas de un lado a otro, pero me va bien para saber que a veces no tienen por qué llamarse igual.. y entender bien bien de dónde vienen y a dónde van... )
